	...
	<div class="about" style="height: 100%;">
		<div class="container">
			<div class="row">
				...
				<c:if test="${m_kind eq 'C'}">
					<a href="goInsertEstimate?mid=${freelancer.m_id}"><input
						id="estimate" type="button" value="견적 요청" /></a>
				</c:if>
			...
			<table class="table table-striped"
				...
				<tr style="text-align: center;">
					<td colspan="3"><img style="width: 400px; height: 250px;"
						src="resources/upload/${photo}" /></td>
				</tr>
				<tr>
					<td>이름</td>
					<td>이메일 주소</td>
